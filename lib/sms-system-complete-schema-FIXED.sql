...
-- Complete Database Schema (FIXED FOR UUID)
-- ============================================
...
-- 3. Message Queue (AI-Managed) - FIXED: customer_id is now UUID
CREATE TABLE IF NOT EXISTS message_queue (
  ...
  priority INTEGER DEFAULT 5, -- 1-10 (AI sets priority)
...
-- 4. AI Message Analytics - FIXED: customer_id is now UUID
...
-- 6. Customer Communication Preferences - FIXED: customer_id is now UUID
...
INSERT INTO message_templates (name, category, message_text, ai_personalization, language) VALUES
-- Thank You Messages
...
INSERT INTO automation_rules (name, trigger_type, trigger_condition, message_template_id, ai_enabled, is_active) VALUES
('Thank You After Purchase', 'after_purchase', '{"delay_hours": 1}', 1, true, true),
('Follow-Up New Customers', 'after_purchase', '{"delay_days": 3, "first_purchase_only": true}', 3, true, true),
('Debt Reminder - Day 3', 'debt_overdue', '{"days_overdue": 3, "min_amount": 100}', 5, true, true),
('Debt Reminder - Day 7', 'debt_overdue', '{"days_overdue": 7, "min_amount": 100}', 7, true, true),
('Debt Reminder - Day 14', 'debt_overdue', '{"days_overdue": 14, "min_amount": 100}', 7, true, true),
('Inactive Customer Re-engagement', 'inactive_customer', '{"days_inactive": 30}', 11, true, false);
...
-- Function to check if customer should receive message - FIXED: parameter is now UUID
...
BEGIN
  ...
  -- If no preferences, assume opt-in
  ...
  -- Don't send if contacted in last hour (prevent spam)
...
-- Then proceed to configure Africa's Talking API
-- ============================================
