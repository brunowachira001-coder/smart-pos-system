...
// Get all valid customer IDs from the export
...
// Insert Returns - SET customer_id to NULL if customer doesn't exist
...
// Insert Debts - SET customer_id to NULL if customer doesn't exist
