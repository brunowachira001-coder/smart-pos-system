...
-- INSERT RETURNS (18)
INSERT INTO returns (
  product_id, quantity, reason, status, refund_amount, created_at
) VALUES
...
-- INSERT DEBTS (4)
INSERT INTO debts (
  customer_id, amount, paid_amount, status, due_date, created_at
) VALUES
...
INSERT INTO shop_settings (
  shop_name, address, phone, email, currency, tax_rate, logo_url
) VALUES (
  'My Shop', NULL, NULL, NULL, 'KES', 0, 'https://ugemjqouxnholwlgvzer.supabase.co/storage/v1/object/public/logos/WhatsApp%20Image%202026-04-23%20at%2011.27.20.jpeg'
);
