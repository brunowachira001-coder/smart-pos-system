...
export default function LandingPage() {
  ...
  const shopName = shopSettings?.shop_name || 'Smart Traders';
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-left">
                ...
                <p className="text-sm text-gray-400">Track stock in real-time and never run out.</p>
              </div>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-left">
                ...
                <p className="text-sm text-gray-400">Analyze performance and grow your business.</p>
              </div>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-left">
                ...
                <h3 className="text-lg font-semibold mb-2">Returns Tracking</h3>
                <p className="text-sm text-gray-400">Manage returns and refunds with ease.</p>
              </div>
            </div>
